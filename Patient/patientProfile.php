            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Date of Appointment</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php  if(isset($_SESSION['d1_id'])){echo $_SESSION['d1_id'];}  ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Department Id</div>

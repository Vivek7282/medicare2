...
<div class="row">
    ...
    Add Marks
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Catogery Of Marks To be Entered</h5>
         ...
         <form    class="form-horizontal" method="post" action="function.php">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary" value="Add Course" name="addmarks">Add Marks</button>

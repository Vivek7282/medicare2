            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic">I am a Neurosurgeon at MNNIT Allahabad hospital.</p>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php  if(isset($_SESSION['add'])){echo $_SESSION['add'];}  ?></div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">City Id</div>
                    <div class="col-lg-9 col-md-8"><?php  if(isset($_SESSION['c_id'])){echo $_SESSION['c_id'];}  ?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="function.php" method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="add" type="text" class="form-control" id="company" value="<?php  if(isset($_SESSION['add'])){echo $_SESSION['add'];}  ?>">
                      </div>
                    </div>
